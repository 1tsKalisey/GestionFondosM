...
requirements = python3,kivy,kivymd,sqlalchemy,aiohttp,multidict,yarl,frozenlist,aiosignal,attrs,propcache,requests,python-dotenv,python-dateutil,apscheduler,cryptography,keyring,google-auth,google-auth-oauthlib
